...
class EightGameNode:
    ...
    def move_left(self):
        ...
        if new.empty["col"] == 0:
            ...
            new.board[new.empty["row"]][new.empty["col"]], new.board[new.empty["row"]][new.empty["col"] - 1] = new.board[new.empty["row"]][new.empty["col"] - 1], new.board[new.empty["row"]][new.empty["col"]]
            new.empty["col"] -= 1
            return new
    ...
    def move_right(self):
        ...
        if new.empty["col"] == 2:
            ...
            new.board[new.empty["row"]][new.empty["col"]], new.board[new.empty["row"]][new.empty["col"] + 1] = new.board[new.empty["row"]][new.empty["col"] + 1], new.board[self.empty["row"]][new.empty["col"]]
            new.empty["col"]+= 1
            return new
    ...
    def move_up(self):
        ...
        if new.empty["row"] == 0:
            ...
            new.board[new.empty["row"]][new.empty["col"]], new.board[new.empty["row"] - 1][new.empty["col"]] = new.board[new.empty["row"] - 1 ][new.empty["col"]], new.board[self.empty["row"]][new.empty["col"]]
            new.empty["row"] -= 1
            return new
