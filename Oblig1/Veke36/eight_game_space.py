...
if __name__ == "__main__":
    ...
    #solution = space.solve(EightGameNode([[1,2,3],[4,5,6],[7,8,0]]))  # Frontier size 1,  Nodes visited  1, Solution length:  1      Hamming: Frontier size 1,  Nodes visited  1, Solution length:  1  Manhattan: Frontier size 1  Nodes visited 1 Solution length: 1
    #solution = space.solve(EightGameNode([[1,2,3],[4,0,6],[7,5,8]]))   # Frontier size 14, Nodes visited  12, Solution length:  3    Hamming: Frontier size 6,  Nodes visited  3, Solution length:  3  Manhattan: Frontier size 6 Nodes visited  3 Solution length:  3
    #solution = space.solve(EightGameNode([[0,1,2],[3,4,5],[6,7,8]]))
    #solution = space.solve(EightGameNode([[1,2,3],[7,4,5],[8,0,6]]))  #Frontier size 70,  Nodes visited  58, Solution length:  6   Hamming: Frontier size 12,  Nodes visited  7, Solution length:  6  Manhattan:  Frontier size 11  Nodes visited  7 Solution length:  6

    # Nei, bredde-først er ikke bra fordi det bruker for lang tid og går gjennom for mange noder, ofte urelevante noder eller noder med lik informasjon.
